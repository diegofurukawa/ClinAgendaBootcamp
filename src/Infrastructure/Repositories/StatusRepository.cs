...
using ClinAgendaBootcamp.src.Application.DTOs.Status; // Importa os DTOs relacionados a Status.
using ClinAgendaBootcamp.src.Core.Interfaces; // Importa a interface que o repositório implementa.
