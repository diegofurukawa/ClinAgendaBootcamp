...
# Diretórios fixos
SOURCE_DIR="$HOME/GitHub/BootCamp_Personal/ClinAgendaBootcamp_Backend"
DEST_DIR="$HOME/GitHub/BKPs/BootCamp_Personal"
...
BACKUP_DIR="$DEST_DIR/ClinAgendaBootcamp_Backend_$TIMESTAMP"
